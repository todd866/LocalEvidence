"""Forensic statistics — data-integrity checks for the studies an answer cites.

Detects impossible or implausible summary statistics in published papers so a
clinical answer can flag a cited study whose numbers cannot be real before relying
on it. Implements the data-integrity tests used by statistical sleuths
(Meyerowitz-Katz; Brown & Heathers, GRIM; etc.).

Ported from paperscope (MIT, (c) 2025-2026 Ian Todd). Pure stdlib + scipy; feed it
extracted table data:

    from localevidence.forensic import (
